$(document).ready(function(){
	...
	var imageUrl = base_url+"assets/back_images/499.gif";
	...
	$loading = $('<center><img src = '+imageUrl+' height = "15px" /></center>');
	...
	$('#login_admin').click(function(){
		...
		if($username == "" && $password == ""){
			...
			setTimeout(function(){
				$loading.remove();
				$.post('Admin_c/login', {username: $username, password: $password},
					function(result){
						if(result == 'success'){
							window.location.reload();
							//window.location = 'Admin_c/home';
						}else{
